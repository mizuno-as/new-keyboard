...
static uint8_t const matrixQwerty[8][12] =
{
    ...
    KEY_TAB, KEY_F1, 0, 0, 0, 0, 0, 0, 0, 0, KEY_F12, KEY_BACKSLASH,
    ...
    KEY_Z, KEY_X, KEY_C, KEY_V, KEY_B, KEY_GRAVE_ACCENT, KEY_ENTER, KEY_N, KEY_M, KEY_COMMA, KEY_PERIOD, KEY_SLASH,
    KEY_LEFTSHIFT, KEY_LEFT_GUI, KEY_FN, KEY_SPACEBAR, KEY_DELETE, KEY_LEFTALT, KEY_RIGHTALT, KEY_BACKSPACE, KEY_ENTER, KEY_FN, KEY_RIGHT_GUI, KEY_RIGHTSHIFT
};
